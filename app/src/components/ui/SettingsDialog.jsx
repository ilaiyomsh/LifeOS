...
import { X, Download, Trash2, RefreshCw, Settings, Database } from 'lucide-react';
...
export const SettingsDialog = ({ onClose }) => {
    ...
    const [activeTab, setActiveTab] = useState('workHours'); // 'workHours' or 'general'
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-200">
                ...
                <div className="flex border-b border-slate-200 bg-slate-50">
                    ...
                    >
                        <Database size={16} /> הגדרות כלליות
                    </button>
                </div>
